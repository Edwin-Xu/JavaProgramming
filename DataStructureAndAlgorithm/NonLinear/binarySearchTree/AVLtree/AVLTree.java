package DataStructureAndAlgorithm.NonLinear.binarySearchTree.AVLtree;

import java.util.ArrayList;
import java.util.List;
import java.util.function.Consumer;
/**
 * AVL树：由两个俄罗斯数学家提出  G.M.Adel'son-Vel'skii  and  E.M.Landis
 * 高度平衡的二叉搜索树，如果他有n个节点，其高度保存在  O(log2(n))，ASL 也保持在O(log2(n))
 *
 * （平衡二叉树，是一种二叉排序树，其中每个结点的左子树和右子树的高度差至多等于1）
 *
 * not mine 有时间了自己写
 * http://www.cnblogs.com/ayanami-rei/p/6126242.html
 */
